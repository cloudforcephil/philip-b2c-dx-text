...
module.exports = {
    app: {
        ...
        login: {
            ...
            social: {
                ...
                idps: ['Google'],
                // Maps each entry in idps to the SLAS IdP name used as the OAuth `hint` query parameter (Account Manager / SLAS).
                idpHints: {
                    Google: 'google-philip-b2c-dx'
                },
        ...
        commerceAPI: {
            ...
            parameters: {
                clientId: '3c34ebf0-0d0e-42a8-973b-583fc7a3d8d1',
                organizationId: 'f_ecom_zzap_297',
                shortCode: 'kv7kzm78',
                siteId: 'philip-b2c-dx-text'
            }
        },
        // Einstein api config
        einsteinAPI: {
    ...
    ssrParameters: {
        ...
        proxyConfigs: [
            ...
            {
                host: 'zzap-297.dx.commercecloud.salesforce.com',
                path: 'ocapi'
            }
        ]
    }
